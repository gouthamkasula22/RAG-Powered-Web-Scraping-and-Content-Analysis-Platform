...
from src.application.interfaces.security import ISecurityService, IScrapingProxy
from src.application.interfaces.scraping import IWebScraper
from src.application.interfaces.analysis import IContentAnalyzer, ILLMService, IReportGenerator
